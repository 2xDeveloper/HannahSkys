import { WATERMARK_BRAND, WATERMARK_SITE } from "@/lib/watermark";

type MediaWatermarkProps = {
  compact?: boolean;
};

/** On-screen overlay for photos and videos (matches burned-in upload watermark). */
export function MediaWatermark({ compact = false }: MediaWatermarkProps) {
  return (
