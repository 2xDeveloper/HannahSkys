      ...
      <div className="shrink-0 px-3 pb-2 pt-3">
        <label className="relative block">
          ...
          <input
            ...
            className="app-input rounded-2xl py-2.5 pl-9 pr-3 text-sm"
          />
        </label>
      </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
        {conversations.length === 0 ? (
          <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#ffe6ef] text-xl text-[#f4699f]">
              ✉
            </div>
            <p className="app-heading mt-4 text-sm font-medium">
                ...
                <li key={convo.id}>
                  <button
                    ...
                    className={`flex w-full items-center gap-3 px-3 py-2.5 text-left transition-colors ${
                      active ? "bg-[#fff0f5]" : "hover:bg-[#fff7fa] active:bg-[#fff0f5]"
                    }`}
                  >
                    <div className="relative h-12 w-12 shrink-0">
                      <div className="h-12 w-12 overflow-hidden rounded-full bg-[#ffe6ef] ring-1 ring-[#fbdce7]">
                        <CreatorAvatar
                    ...
                    <div className="min-w-0 flex-1 border-b border-[#fdeaf1] pb-2.5">
                      <div className="flex items-baseline justify-between gap-2">
                        <p
                          className={`truncate text-[15px] ${
                            unread ? "font-semibold text-[#3f3a44]" : "font-medium text-[#55505c]"
                          }`}
                        >
                          {convo.partnerName}
                          {convo.isGuest && (
                        ...
                        <span
                          className={`shrink-0 text-[11px] ${
                            unread ? "font-medium text-[#f4699f]" : "text-[#8a8390]"
                          }`}
                        >
